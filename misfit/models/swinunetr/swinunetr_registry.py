...
MIST SwinUNETR at the same feature_size.
    ...
    feature_size=24  →  swinunetr-small   (~4.8M encoder parameters)
    feature_size=48  →  swinunetr-base    (~18.6M encoder parameters)
    feature_size=96  →  swinunetr-large   (~73.9M encoder parameters)
"""
